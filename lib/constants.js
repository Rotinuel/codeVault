...
// Bookmakers offered in the upload form ("Other" lets the client type one).
export const BOOKMAKERS = ["SportyBet", "Bet9ja", "BetKing", "1xBet", "Betway", "MSport", "BangBet", "NairaBet", "Merrybet", "22Bet", "Other"];
...
export const NOTIFICATION_EVENTS = Object.freeze({
  ...
  BROADCAST: "BROADCAST",
  WINNING_TICKET_REVIEWED: "WINNING_TICKET_REVIEWED",
});
...
export const NOTIFICATION_EVENT_LABELS = {
  ...
  WINNING_TICKET_REVIEWED: "Winning ticket reviewed",
};
...
// Bump when the terms change; stored on each account when accepted at sign-up.
